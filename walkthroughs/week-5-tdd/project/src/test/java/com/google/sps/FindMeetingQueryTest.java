...
public final class FindMeetingQueryTest {
  ...
  public void notEnoughRoom() {
    ...
    //sesexton@ New Implementation

    //Test 1
    @Test
    public void everyAttendeeIsConsideredWithOptionalAllDayEvent() {
    ...
    //Test 2
    @Test
    public void everyAttendeeIsConsideredWithOptionalEventPerson() {
        ...
        Collection<TimeRange> actual = query.query(events, request);
        Collection<TimeRange> expected =
            Arrays.asList(TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0800AM, true),
                TimeRange.fromStartEnd(TIME_0830AM, TIME_0900AM, false),
                TimeRange.fromStartEnd(TIME_0930AM, TimeRange.END_OF_DAY, true));
    ...
    //Test 3
      @Test
  public void justEnoughRoomWithOptionalAttendeeB() {
  ...
  public void noMandatoryTwoOptionalWithNoGaps() {
    ...
    Collection<TimeRange> actual = query.query(events, request);
    Collection<TimeRange> expected =
        Arrays.asList(TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TimeRange.END_OF_DAY, false));
